...
<html>
    ...
    <script>
        ...
        function signOut() {
            document.getElementsByClassName("nav-login")[0].style.display = "inline";
            document.getElementsByClassName("nav-login")[1].style.display = "none";
            document.getElementsByClassName("nav-login")[1].innerHTML = "";
            document.getElementsByClassName("booking")[0].style.display = "none";
            document.getElementsByClassName("booking")[1].style.display = "none";
        }
